...
const ListingsPage = () => {
  ...
  const { property_for, property_in, sub_type, bhk, location, loading, error } = useSelector((state) => state.search);
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      ...
      try {
        ...
        const url = new URL('https://api.meetowner.in/listings/v1/getAllPropertiesByType');
    ...
    fetchProperties();
  }, [currentPage, property_for, property_in, sub_type, bhk, location, dispatch]); // Add sub_type to dependencies
      ...
      <div className="space-y-3">
        {properties.map((property) => (
          <PropertyCard
            ...
            enquiries={property.enquiries || 0} // Adjust if API provides this
